...
<div class="space-bottom--l">
    <div class="c-strip">
        <div class="l-container">
            ...
            <h1 itemprop="headline"><?php echo get_field('hero_title', '9'); ?></h1>
            <p><?php echo get_field('hero_body', '9'); ?></p>
        </div>
    </div>
</div>
...
<div id="kbe_content" <?php echo $kbe_content_class; ?>>
        ...
        <!--leftcol-->
        <div class="kbe_leftcol l-container__main">
                ...
                if ($children) {
                    ...
                    <h2>
                        <span class="kbe_count"><?php
                            echo sprintf(_n('%d Article', '%d Articles', $kbe_count_sum_parent, 'wp-knowledgebase'), $kbe_count_sum_parent); ?></span>
                        <a href="<?php echo get_term_link($kbe_term_slug, 'kbe_taxonomy'); ?>"><?php
                            echo $kbe_term_name; ?></a>
                    </h2><?php
                ...
                if ($kbe_child_terms) {
                    ?><div class="kbe_child_category" style="display: none;"><?php
                            foreach ($kbe_child_terms as $kbe_child_term) {
                                ...
                                $kbe_child_term_name = $kbe_child_term->name; ?><h3>
                                    <span class="kbe_count"><?php
                                        echo sprintf(_n('%d Article', '%d Articles', $kbe_child_term->count, 'wp-knowledgebase'), $kbe_child_term->count); ?></span>
                                    <a href="<?php echo get_term_link($kbe_child_term_slug, 'kbe_taxonomy'); ?>"><?php
                                        echo $kbe_child_term_name; ?></a>
                                </h3>
                                ...
                                if ($kbe_child_post_qry->have_posts()) :
                                        while ($kbe_child_post_qry->have_posts()) :
                                            $kbe_child_post_qry->the_post(); ?><li>
...
>>>>>>> 179daf2f3256e39083f19551f72746ee7242d76e
        ...
        <!--/leftcol-->
        <div class="kbe_aside l-container__sidebar ">
