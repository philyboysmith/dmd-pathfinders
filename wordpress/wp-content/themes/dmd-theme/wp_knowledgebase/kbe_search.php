...
if (! empty($_GET['ajax']) ? $_GET['ajax'] : null) {
    if (have_posts()) {
        ?><ul id="search-result"><?php
            ...
            while (have_posts()) : the_post(); ?><li><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></li><?php
            endwhile; ?></ul><?php
    } else {
    ...
    <div class="c-strip">
        <div class="l-container">
            ...
            <h1 itemprop="headline"><?php echo sprintf(__('Search Results for: %s', 'wp-knowledgebase'), esc_html($_GET['s'])); ?></h1>
        </div>
    </div>
</div>
...
<div class="l-container">
	<?php kbe_search_form(); ?>
	<div id="kbe_container"><div id="kbe_content" <?php echo $kbe_content_class; ?>><?php
