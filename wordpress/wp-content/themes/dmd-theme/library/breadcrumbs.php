...
function custom_breadcrumbs()
{
    ...
    $breadcrums_class   = 'c-breadcrumbs  c-breadcrumbs--white';
    $home_title         = 'Home';
    ...
    if (!is_front_page()) {
        ...
        if (is_archive() || is_tax() || is_category() || is_tag() || is_single()) {
            echo '<li class="item-current item-archive"><a href="/news"><span class="bread-current bread-archive">News</span></a></li>';
        }
        ...
        if (is_archive() && !is_tax() && !is_category() && !is_tag()) {
            ...
            echo '<li class="item-current item-cat"><span class="bread-current bread-cat">News</span></li>';
        } elseif (is_category()) {
